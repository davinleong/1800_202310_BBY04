        ...
        .then(userDoc => {
            ...
            bookmarks.forEach(thisBusID => {
                ...
                db.collection("busStops").doc(thisBusID).get().then(doc => {
                    ...
                    var details  = doc.data().details ; //get unique ID to each buses to be used for fetching right image
                    var busSchedule  = doc.data().schedule ; //gets the length field
                    var busCode = doc.data().code;
                    ...
                    newcard.querySelector('.card-length').innerHTML =
                        "<i>Schedule: " + busSchedule + "<br>" +
                        "Details: " + details + "<br>" +
                        "Last updated: " + doc.data().last_updated.toDate().toLocaleDateString() +"</i>";

					//Finally, attach this new card to the gallery
                    busCardGroup.appendChild(newcard);
                })
            });
        })
}
